...
<body>
    ...
    <script>
        ...
        async function checkWhatsAppStatus() {
            try {
                const response = await fetch('conexion/whatsapp_proxy_real_estate3.php?action=status');
        ...
        document.getElementById('startWhatsAppBtn').addEventListener('click', async function() {
            ...
            try {
                const response = await fetch('conexion/whatsapp_proxy_real_estate3.php?action=start', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        async function stopWhatsApp() {
            try {
                ...
                const response = await fetch('conexion/whatsapp_proxy_real_estate3.php?action=stop', {
                    method: 'POST'
                });
